...
# we are going to create: a sprite class for the player and a sprite class for each obstacle
# this would be the most common way of orginizing this sort of game
...
while True:
        ...
        for event in pygame.event.get():
          ...
          if game_active:
            if event.type == obstacle_timer: 
                    obstacle_group.add(Obstacle(choice(['fly','snail','snail','snail']))) # choice will choose one of these four items so 24 percent chance to get a fly
        ...
        if game_active:          
            ...
            if current_time<37: fps_intended = 35  
            elif 37<=current_time<50: fps_intended = 50
            elif 50<=current_time<100: fps_intended = 50
            elif 100<=current_time<129: fps_intended = 60
            elif 129<=current_time<153: fps_intended = 50
            elif 153<=current_time<178: fps_intended = 30
            elif 178<=current_time<200: fps_intended = 70
            elif 200<=current_time<222: fps_intended = 40
            elif 222<=current_time<245: fps_intended = 50
            elif 245<=current_time<248: fps_intended = 60
            elif 248<=current_time<286: fps_intended = 60
            elif 286<=current_time<312: fps_intended = 60
            ...
            score_message = test_font.render(f'Your score: {score}',False,(255,172,176))
